...
- Only the fixed prayer strip is measured by `ResizeObserver`; the unboxed logo, icons and section tabs scroll with the page. Do not add fixed top padding to every `main` element.

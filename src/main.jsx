...
(async () => {
  try {
    ...
    // The compact Qur'an/Hadith reminder is intentionally preview-first.
    // Clicking it toggles the complete text/source without changing the navbar component contract.

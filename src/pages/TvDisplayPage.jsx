...
export default function TvDisplayPage() {
  ...
  return <div ref={screen} className="jic-tv-display" onDoubleClick={enterFullscreen}>
    ...
    <main className={`jic-tv-stage ${showLive ? 'is-live' : ''}`} aria-label={showLive ? 'Livestream and posters' : 'Community posters'}>
      {showLive && <section className="jic-tv-video"><h1>{livestream.title || 'JIC Livestream'}</h1><YouTubeScreenPlayer videoId={videoId} title={livestream.title} muted onUnavailable={onUnavailable}/></section>}

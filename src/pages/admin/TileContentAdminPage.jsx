...
async function uploadTileImage(file,key){
  if(!file)return null;
  const ext=validateImage(file);const path=`home-tiles/${key}-${crypto.randomUUID()}.${ext}`;

  ...
  async function prepare() {
    ...
    try {
      ...
      try {
        ...
        /* Use image/download fallback. */
      }
      setPreview({
        url: URL.createObjectURL(blob),
        title: `${currentMonth} prayer timetable`,
        file,
        filename,
        canShare,
      });
    } catch (problem) {
      if (mounted.current) setError(problem.message || 'Unable to create the wallpaper.');
    } finally {
  ...
  async function share() {
    ...
    try {
      ...
      if (problem.name !== 'AbortError')
        setError('Sharing is unavailable here. Use Download JPEG, or open the image and save it.');
    }
  }
  ...
  return (
    <div className="jic-wallpaper-control">
      ...
      {preview && (
        ...
        >
          <p>
            On iPhone, tap Share / Save and choose Save Image or Save to Files. You can also open
            the image and press and hold to save it.
          </p>

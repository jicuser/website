...
const communityServices = [
  {
    ...
    title: 'Charity & Zakat',
    description:
      'Collection and distribution of Zakat and Sadaqah to help those in need in our community.',
  },
  {
    icon: <Coffee className="h-10 w-10 text-primary" />,
    title: 'Community Gatherings',
    description:
      'Regular social events to strengthen community bonds and provide networking opportunities.',
  },
  {
    icon: <Gift className="h-10 w-10 text-primary" />,
    title: 'Food Bank',
    description:
      'Weekly food distribution service for families in need, regardless of faith or background.',
  },
  {
    icon: <Users className="h-10 w-10 text-primary" />,
    title: 'Youth Programs',
    description:
      'Activities and mentoring programs specifically designed for Muslim youth and teenagers.',
  },
  {
    icon: <Headphones className="h-10 w-10 text-primary" />,
    title: 'Counseling Services',
    description:
      'Professional counseling for individuals and families facing personal or social challenges.',
  },
  {
    icon: <Globe className="h-10 w-10 text-primary" />,
    title: 'Interfaith Activities',
    description:
      'Collaborative events with other faith communities to promote understanding and harmony.',
  },
];
    ...
    <>
      ...
      >
        ...
        <p className="text-lg mb-6 max-w-2xl mx-auto">
          Our community services rely on dedicated volunteers. Join us in making a difference in our
          community by volunteering your time and skills.
        </p>

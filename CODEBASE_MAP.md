...
| Previous-page history and Home/Back  | `src/context/NavigationContext.jsx`, `src/lib/navigationHistory.js` |
| Scroll on route changes              | `src/components/shell/RouteScrollReset.jsx`                         |

...
export const variants = [
  ...
  ['pillars-outline', 'Outline pillars & wordmark', 984, 378, () => (tower(0,0,.65)+tower(916,0,.65)).replaceAll('class="metal"','class="metal" style="fill:none;stroke:currentColor;stroke-width:1.8"')+wordmark(72,60,840)],
];
